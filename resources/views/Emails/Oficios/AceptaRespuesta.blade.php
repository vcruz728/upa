...
<head>
    ...
    <title>Respuesta aceptada</title>
</head>
            ...
            <td align="center" style="padding: 20px;">
                <table class="content" width="600" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border: 1px solid #cccccc;">
                    ...
                    <tr>
                        ...
                        {{ $nombre }} <br>
                        @if($tipo == 1)
                            Le notificamos que la respuesta del oficio con número de folio/oficio: {{ $folio }}, ha sido autorizada por su jefe de área.
                        @else
                            Le notificamos que el nuevo oficio, ha sido autorizado por su jefe de área.
                        @endif
                        </td>
                    </tr>
