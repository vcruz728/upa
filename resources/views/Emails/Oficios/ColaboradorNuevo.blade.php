            ...
            <td align="center" style="padding: 20px;">
                <table class="content" width="600" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border: 1px solid #cccccc;">
                    ...
                    <tr>
                        ...
                        {{ $jefe }} <br>
                        Le notificamos que el colaborador {{ $colaborador }} ha generado un nuevo oficio
                        <br><br>
                            ...
                            <table cellspacing="0" cellpadding="0" style="margin: auto;">
                                <tr>
                                    <td align="center" style="background-color: #345C72; padding: 10px 20px; border-radius: 5px;">
                                        <a href="{{ url('/oficios/nuevo/revisa-respuesta/'.$id) }}" target="_blank" style="color: #ffffff; text-decoration: none; font-weight: bold;">Ver Oficio</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
